...
a persistence unit "ups.edu.ec.ArmijosFabian.SriJEE.DAOPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ups.edu.ec.ArmijosFabian.SriJEE.DAO\pom.xml":
...
artifact ("ups.edu.ec.ArmijosFabian.SriJEE.DAO.war") is already built. You can build
